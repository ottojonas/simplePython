...
logitics_img_data = Image.open("inventoryManagement/logistics_icon.png")
...
shipping_img_data = Image.open("inventoryManagement/shipping_icon.png")
...
delivered_img_data = Image.open("inventoryManagement/delivered_icon.png")
